 ...
 */
export function drawWaveform(ctx, buffer, width, height, color) {
    ...
    if (maxAmplitude === 0)
        maxAmplitude = 0.01; // Avoid division by zero
 ...
 */
export function getAccentColor(element, fallbackColor = "#007aff") {
